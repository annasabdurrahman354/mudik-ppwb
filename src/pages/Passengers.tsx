...
const Passengers = () => {
  ...
  return (
    <div className="pb-20 px-2 container max-w-3xl mx-auto">
      <motion.div
        ...
        className="py-4"
      >
        <h1 className="text-2xl font-bold text-center mb-1">Passenger Management</h1>
        <p className="text-center text-muted-foreground text-sm mb-4">Manage passenger bookings and assignments</p>
      </motion.div>
